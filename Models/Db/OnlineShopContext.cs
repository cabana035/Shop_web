...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Banner>(entity =>
        {
            ...
            entity.Property(e => e.Link).HasMaxLength(10);
            entity.Property(e => e.Position).HasMaxLength(50);
            entity.Property(e => e.Subtile).HasMaxLength(1000);
        ...
        modelBuilder.Entity<Menu>(entity =>
        {
            ...
            entity.Property(e => e.MenuTitle).HasMaxLength(300);
        ...
        modelBuilder.Entity<ProductGalery>(entity =>
        {
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.ProductGaleries)
                ...
                .HasConstraintName("FK_ProductGalery_Products");
        });

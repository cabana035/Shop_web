...
namespace Shop_web.Areas.Admin.Controllers
{
    ...
    public class BannersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Subtile,ImageName,Priority,Link,Position")] Banner banner, IFormFile ImageFile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Subtile,ImageName,Priority,Link,Position")] Banner banner, IFormFile? ImageFile)
        {
            if (id != banner.Id)
            {
                return NotFound();
